...
/**
 * <p>Java class for MessageKey complex type.
 * 
...
public class MessageKey {
    ...
    protected String requestUUID;// = messageKey.getRequestUUID();
    @XmlElement(name = "ServiceRequestId", required = true)
    protected String serviceRequestId;// = messageKey.getServiceRequestId();
    @XmlElement(name = "ServiceRequestVersion", required = true)
    protected String serviceRequestVersion;// = messageKey.getServiceRequestVersion();
    @XmlElement(name = "ChannelId", required = true)
    protected String channelId;// = messageKey.getChannelId();
